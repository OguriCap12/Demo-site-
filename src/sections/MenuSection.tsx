      ...
      <Container>
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          ...
          <div className="min-w-0">
                ...
                {menuCategories.map((category) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      className={[
                        'min-w-0 rounded-full px-3 py-3 text-[0.64rem] font-semibold uppercase tracking-editorial transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ember focus-visible:ring-offset-2 focus-visible:ring-offset-ivory',
                        isActive ? 'bg-charcoal text-ivory shadow-[0_8px_24px_rgba(23,21,18,0.16)]' : 'bg-transparent text-charcoal/62 hover:bg-charcoal/6',
                      ].join(' ')}
            ...
            <Reveal key={activeCategory.id} className="mt-7 border-b border-charcoal/10 bg-white/45 px-1 py-6 sm:px-2 sm:py-8">
              <div className="flex flex-col gap-4 border-b border-charcoal/10 pb-6 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <h3 className="mt-3 font-serif text-[2.8rem] leading-none tracking-[-0.025em] sm:text-5xl">{activeCategory.label}</h3>
                </div>
              ...
              <div className="mt-2 divide-y divide-charcoal/10">
                {activeCategory.items.map((item, index) => (
                  <article key={item.name} className="group grid gap-3 py-6 transition hover:bg-charcoal/[0.025] sm:grid-cols-[1fr_auto] sm:items-start sm:gap-8">
                    <div>
